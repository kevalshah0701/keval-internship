      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <label>First name :</label>
            <input type="text" name="" id="First name" class="form-control" placeholder= "please enter your first name ">
        </div>

        <div class="form-group">
          <label>Last name :</label>
            <input type="text" name="" id="Last name" class="form-control" placeholder= "please enter your Last name ">
        </div>
