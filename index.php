...
if(isset($_GET['delete'])){
  $id = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `author_master` WHERE `id`=$id";
...
if (isset( $_POST['idEdit'])){
  ...
  $sql = "UPDATE `author_master` 
          SET `name`    = '$name',
              `dob`     = '$dob', 
              `status`  = '$status',
              `address` = '$address' 

  WHERE `author_master`.`id` = $id";
  ...
  $sql ="INSERT INTO `author_master`(`name`, `dob`, `status`, `address`)
         VALUES ('$name', '$dob', '$status', '$address')";
...
<body>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="editModalLabel">Update your details: </h5>
        ...
        <form action="/crud/index.php" method="POST">
          ...
          <div class="modal-body">
            ...
            <label for="title">Date of birth : </label>
              <input type="text" class="form-control" id="dobEdit" name="dobEdit" aria-describedby="emailHelp">
  ...
  <div class="container my-4">
    ...
    <form action="/crud/index.php" method="POST" target="edit" onsavechanges="setTimeout(function(){window.location.reload();},10);">
      ...
      <button type="submit" class="btn btn-primary">Add Your data</button>
    </form>
  </div>
  ...
  <script>
    ...
    Array.from(edits).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        console.log(name,dob,status,address);
        nameEdit.value    = name;
        dobEdit.value     = dob;
